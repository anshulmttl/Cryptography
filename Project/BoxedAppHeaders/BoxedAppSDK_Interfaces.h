...
/* at Wed Apr 24 17:54:02 2019
 */
/* Compiler settings for v:\builds\BoxedApp\files\5A355AFC\trunk\src\BoxedApp\src\BoxedAppSDK\BoxedAppSDK_Interfaces.idl:
...
HRESULT STDMETHODCALLTYPE IBxVirtualEnvironment_SetDefaultRegistryLayer_Proxy( 
    IBxVirtualEnvironment * This,
    /* [in] */ IUnknown *layer);


void __RPC_STUB IBxVirtualEnvironment_SetDefaultRegistryLayer_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
